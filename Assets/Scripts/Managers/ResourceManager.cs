...
public class ResourceManager : MonoBehaviour
{
    ...
    private readonly Dictionary<string, AssetBundleInfo> m_LoadedAssetBundles = new Dictionary<string, AssetBundleInfo>();
    private readonly Dictionary<string, List<LoadAssetRequest>> m_LoadRequests = new Dictionary<string, List<LoadAssetRequest>>();

    // Load AssetBundleManifest.
    public void Initialize(string manifestName, Action initOK)
    {
        m_BaseDownloadingURL = App.GetRelativePath();
    ...
    {
        if (abName.Equals(LuaConst.assetDir))
        {
            return abName;
        }
...
public class ResourceManager : MonoBehaviour
{
    private readonly string[] m_Variants = { };
    ...
    public void Initialize()
    {
        ...
        uri = App.DataPath + LuaConst.assetDir;
